...
app.post('/addTodo', (request, response) => {
    db.collection('things-todo').insertOne({thing: request.body.todoItem, completed: false})
    .then(result => {
...
app.put('/markComplete', (request, response) => {
    db.collection('things-todo').updateOne({thing: request.body.itemFromJS},{
        $set: {
            completed: true
          }
    },{
...
app.delete('/deleteItem', (request, response) => {
    db.collection('things-todo').deleteOne({thing: request.body.itemFromJS})
    .then(result => {
        console.log('To-do task deleted')
